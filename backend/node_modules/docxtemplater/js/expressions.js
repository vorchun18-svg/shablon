...
function configuredParser() {
  ...
  if (!hasProxy) {
    if (config.evaluateIdentifier) {
      throw new Error("evaluateIdentifier is not supported because your environment does not have Proxy");
    }
    if (config.setIdentifier) {
      throw new Error("setIdentifier is not supported because your environment does not have Proxy");
    }
  }
  var lastResult = null;
    ...
    return {
      get: function get(scope, context) {
        if (!hasProxy) {
          ...
          var _scopeList = context.scopeList;
          var index = getIndex(scope, context);
          var num = context.num;
          for (var i = 0, len = num + 1; i < len; i++) {
            obj = assign(obj, _scopeList[i]);
          }
          obj = assign(obj, {
            $index: index
          });
          var _result2 = expr(scope, obj);
          if (isAssignment) {
            return "";
          }
          if (typeof config.postEvaluate === "function") {
            _result2 = config.postEvaluate(_result2, tag, scope, context);
          }
          return _result2;
        }
        var scopeList = context.scopeList;
        var promises = [];
        var px = new Proxy(Object.create(null), {
          ...
          get: function get(target, name) {
            ...
            if (hasOwn(scope, name) && scope[name] != null) {
              ...
              return typeof property === "function" ? bind(property, scope) : property;
            }
            for (var _i1 = scopeList.length - 1; _i1 >= 0; _i1--) {
              var s = scopeList[_i1];
              if (s != null && hasOwn(s, name) && s[name] != null) {
                var _property = s[name];
                return typeof _property === "function" ? bind(_property, s) : _property;
              }
            }
            return null;
          },
          ...
          has: function has(target, name) {
            ...
            for (var _i10 = scopeList.length - 1; _i10 >= 0; _i10--) {
              var s = scopeList[_i10];
          ...
          set: function set(target, name, value) {
            if (value instanceof Promise) {
              promises.push(value.then(function (value) {
                ...
                for (var _i11 = scopeList.length - 1; _i11 >= 0; _i11--) {
                  var s = scopeList[_i11];
            ...
            for (var _i12 = scopeList.length - 1; _i12 >= 0; _i12--) {
              var s = scopeList[_i12];
              if (_typeof(s) === "object" && s) {
                s[name] = value;
                return true;
              }
          ...
          getOwnPropertyDescriptor: function getOwnPropertyDescriptor(target, name) {
            ...
            for (var _i13 = scopeList.length - 1; _i13 >= 0; _i13--) {
              var s = scopeList[_i13];
              if (s && hasOwn(s, name)) {
                return {
                  writable: true,
                  enumerable: true,
